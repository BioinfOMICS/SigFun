# Test file for .extractGeneSetsDF function
...
test_that(".extractGeneSetsDF subsets correctly for numeric showCategory", {
  ...
  out <- .extractGeneSetsDF(gr, showCategory = 2)
  expect_identical(out, expected_df)
})

test_that(".extractGeneSetsDF subsets correctly for character showCategory", {
  ...
  out <- .extractGeneSetsDF(gr, showCategory = showChar)
  expect_identical(out, expected_df)
})

test_that(".extractGeneSetsDF errors when character showCategory not found", {
  ...
  expect_error(
    .extractGeneSetsDF(gr, showCategory = "NotThere"),
