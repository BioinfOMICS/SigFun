...
You need to have R 4.4.0 or a later version installed for running LipidSigR.
...
installation of the lipidTrend package.
...
significat_type="pval"
strings=c("KEGG")
SE_data.cor <- SigFun::SigCor(SE_data=SE_data, cor.method=cor.method,
...
```{r Sig2GSEA}
SE_data.fgsea <- SigFun::Sig2GSEA(SE_data.cor=SE_data.cor,
                        ranking.method=ranking.method,
                        output_path=output_path, 
                        pathways.all=pathways.all)
```

# Step 3. plot_bar: barplot for visualization

```{r plot.bar}
barplots <- SigFun::plot_bar(SE_data.fgsea=SE_data.fgsea, 
                        output_path=output_path,
                        topN=topN, significat_type=significat_type, 
                        strings = strings)
```

# Step 3. plot_heat: heatmap for visualization

```{r heatmap}
heatmap <- SigFun::plot_heat(SE_data.fgsea=SE_data.fgsea, 
                        output_path=output_path,
